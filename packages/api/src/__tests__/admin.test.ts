...
describe('Admin NAS Endpoints', () => {
  it('should direct admins to system endpoints for NAS management', () => {
    // Deprecated docker-in-docker NAS actions were removed; system endpoints remain covered elsewhere
