...
import mainsTestRouter from './routes/mainsTest';
...
app.use('/api/mains-test', mainsTestRouter); // Mains Performance Test: Water supply testing with pressure/flow/temperature monitoring
