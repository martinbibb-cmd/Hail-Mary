...
export const AuthScreen: React.FC = () => {
  const { error, login, register, requestPasswordReset, clearError, authConfig, nasMode, getNasUsers, nasLogin } = useAuth();
  ...
  // Extract Google OAuth enabled status
  const googleAuthEnabled = authConfig?.googleAuthEnabled ?? false;
